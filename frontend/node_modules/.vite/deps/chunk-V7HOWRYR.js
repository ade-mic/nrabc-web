...
function clampWrapper(value, min = 0, max = 1) {
  ...
  return clamp_default2(value, min, max);
}
...
function deepClone2(source) {
  if (React21.isValidElement(source) || (0, import_react_is3.isValidElementType)(source) || !isPlainObject2(source)) {
    return source;
  }
  const output = {};
  Object.keys(source).forEach((key) => {
...
function deepmerge2(target, source, options = {
  ...
  if (isPlainObject2(target) && isPlainObject2(source)) {
    Object.keys(source).forEach((key) => {
      if (React21.isValidElement(source[key]) || (0, import_react_is3.isValidElementType)(source[key])) {
        output[key] = source[key];
...
var useEnhancedEffect2 = typeof window !== "undefined" ? React25.useLayoutEffect : React25.useEffect;
...
var elementAcceptingRef2 = chainPropTypes2(import_prop_types10.default.element, acceptingRef2);
elementAcceptingRef2.isRequired = chainPropTypes2(import_prop_types10.default.element.isRequired, acceptingRef2);
...
var elementTypeAcceptingRef_default2 = chainPropTypes2(import_prop_types11.default.elementType, elementTypeAcceptingRef2);
...
var refType2 = import_prop_types12.default.oneOfType([import_prop_types12.default.func, import_prop_types12.default.object]);
...
function getThemeProps2(params) {
  ...
  if (config.defaultProps) {
    return resolveProps2(config.defaultProps, props);
  }
  if (!config.styleOverrides && !config.variants) {
    return resolveProps2(config, props);
  }
  return props;
}
function useDefaultProps({
  ...
  const ctx = React45.useContext(PropsContext);
...
if (true) {
  true ? ThemeProvider3.propTypes = exactProp3(ThemeProvider3.propTypes) : void 0;
}
...
function useCurrentColorScheme(options) {
  ...
  const [isClient, setIsClient] = React48.useState(noSsr || !isMultiSchemes);
  React48.useEffect(() => {
    setIsClient(true);
  }, []);
  const colorScheme = getColorScheme(state);
  const setMode = React48.useCallback((mode) => {
  ...
  const setColorScheme = React48.useCallback((value) => {
    if (!value) {
      setState((currentState) => {
        try {
  ...
  const handleMediaQuery = React48.useCallback((event) => {
  ...
  const mediaListener = React48.useRef(handleMediaQuery);
...
function createCssVarsProvider(options) {
  ...
  const ColorSchemeContext = React49.createContext(void 0);
  if (true) {
    ColorSchemeContext.displayName = "ColorSchemeContext";
  }
  const useColorScheme = () => React49.useContext(ColorSchemeContext) || defaultContext;
  ...
  function CssVarsProvider(props) {
    ...
    const hasMounted = React49.useRef(false);
    const upperTheme = useTheme4();
    const ctx = React49.useContext(ColorSchemeContext);
    const nested = !!ctx && !disableNestedContext;
    const initialTheme = React49.useMemo(() => {
      if (themeProp) {
        return themeProp;
      }
    ...
    const allColorSchemes = React49.useMemo(() => joinedColorSchemes.split(","), [joinedColorSchemes]);
    ...
    const memoTheme2 = React49.useMemo(() => {
      var _a2;
    ...
    const element = (0, import_jsx_runtime10.jsxs)(React49.Fragment, {
  ...
  const Grid2 = React52.forwardRef(function Grid3(inProps, ref) {
    ...
    return (0, import_jsx_runtime12.jsx)(GridRoot, {
      ...
      children: React52.Children.map(children, (child) => {
        var _a;
        if (React52.isValidElement(child) && isMuiElement3(child, ["Grid"]) && container && child.props.container) {
...
var SvgIcon = React58.forwardRef(function SvgIcon2(inProps, ref) {
  ...
  const hasSvgAsChild = React58.isValidElement(children) && children.type === "svg";
  const ownerState = {
    ...props,
    color: color2,
    component,
...
var useEnhancedEffect_default4 = useEnhancedEffect_default;
...
var useEventCallback_default3 = useEventCallback_default;
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-V7HOWRYR.js.map
