...
var elementAcceptingRef2 = chainPropTypes2(import_prop_types22.default.element, acceptingRef2);
elementAcceptingRef2.isRequired = chainPropTypes2(import_prop_types22.default.element.isRequired, acceptingRef2);
...
var elementTypeAcceptingRef_default2 = chainPropTypes2(import_prop_types23.default.elementType, elementTypeAcceptingRef2);
...
var refType2 = import_prop_types24.default.oneOfType([import_prop_types24.default.func, import_prop_types24.default.object]);
...
function isMuiElement3(element, muiNames) {
  var _a, _b, _c;
  return React43.isValidElement(element) && muiNames.indexOf(
    // For server components `muiName` is avaialble in element.type._payload.value.muiName
    // relevant info - https://github.com/facebook/react/blob/2807d781a08db8e9873687fccc25c0f12b4fb3d4/packages/react/src/ReactLazy.js#L45
    // eslint-disable-next-line no-underscore-dangle
    element.type.muiName ?? ((_c = (_b = (_a = element.type) == null ? void 0 : _a._payload) == null ? void 0 : _b.value) == null ? void 0 : _c.muiName)
...
var useEnhancedEffect2 = typeof window !== "undefined" ? React44.useLayoutEffect : React44.useEffect;
...
function useControlled2({
  ...
  } = React46.useRef(controlled !== void 0);
  const [valueState, setValue] = React46.useState(defaultProp);
  ...
  const setValueIfUncontrolled = React46.useCallback((newValue) => {
    if (!isControlled) {
      setValue(newValue);
    }
  }, []);
...
function useEventCallback(fn) {
  const ref = React47.useRef(fn);
  useEnhancedEffect_default3(() => {
    ref.current = fn;
  });
  return React47.useRef((...args) => (
...
function useLazyRef2(init, initArg) {
  const ref = React49.useRef(UNINITIALIZED);
...
function getValidReactChildren2(children) {
  return React53.Children.toArray(children).filter((child) => React53.isValidElement(child));
}
...
export {
  ...
  createGrid,
  createStack,
  require_react_is4 as require_react_is,
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-SCVXJQ3S.js.map
