...
import {
  ...
  Link_default as Link_default2,
  Redo_default,
  StrikethroughS_default,
  Subscript_default,
  Superscript_default,
  Undo_default
} from "./chunk-SL6IPSYD.js";
import {
  Box_default,
  Button_default,
  ClickAwayListener,
...
} from "./chunk-3R3BI37C.js";
import "./chunk-6F3VBANY.js";
import {
  Image
} from "./chunk-EJXSZVCL.js";
import {
  Decoration,
  DecorationSet,
  Extension,
  ...
  mergeAttributes,
  posToDOMRect
} from "./chunk-GLDA2KU6.js";
import {
  FormatAlignCenter_default
} from "./chunk-BMLKX3T3.js";
import {
  FormatListBulleted_default
} from "./chunk-S7LVNTD2.js";
import "./chunk-YR5LAKKR.js";
import {
  FormatAlignLeft_default
} from "./chunk-CBDBHJUW.js";
import {
  FormatListNumbered_default
} from "./chunk-CBKQPKJJ.js";
import {
  FormatAlignRight_default
} from "./chunk-DIYN2OMO.js";
import "./chunk-C6WWHQR7.js";
import {
  createSvgIcon,
  svgIconClasses_default
} from "./chunk-NDE4WT3D.js";
import {
  Typography_default
} from "./chunk-WXZ5JKUW.js";
import "./chunk-BVW3HJUF.js";
import {
  Paper_default
} from "./chunk-552VKBWU.js";
import "./chunk-FA2F5PGR.js";
import {
...
var ColorSwatchButton = (0, import_react24.forwardRef)(({ value: colorValue, label, padding, active, ...buttonProps }, ref) => {
  ...
  return (0, import_jsx_runtime36.jsx)("button", { ref, type: "button", style: { backgroundColor: colorValue, padding }, "aria-label": label !== null && label !== void 0 ? label : colorValue, value: colorValue, ...buttonProps, className: cx(classes.root, !colorValue && classes.colorNotSet, buttonProps.className), children: active && (0, import_jsx_runtime36.jsx)(Check_default, { fontSize: "small", className: classes.activeIcon, style: {
...
function MenuButtonAddImage({ ...props }) {
  const editor = useRichTextEditorContext();
  return (0, import_jsx_runtime39.jsx)(MenuButton, { tooltipLabel: "Insert image", IconComponent: AddPhotoAlternate_default, disabled: !(editor === null || editor === void 0 ? void 0 : editor.isEditable) || // We can use any URL here for testing `can` (to see if an image can be
...
function MenuButtonEditLink(props) {
  ...
  return (0, import_jsx_runtime51.jsx)(MenuButton, { buttonRef, tooltipLabel: "Link", tooltipShortcutKeys: ["mod", "Shift", "U"], IconComponent: Link_default2, selected: editor === null || editor === void 0 ? void 0 : editor.isActive("link"), disabled: !(editor === null || editor === void 0 ? void 0 : editor.isEditable), onClick: () => (
...
function MenuButtonHorizontalRule(props) {
  const editor = useRichTextEditorContext();
  return (0, import_jsx_runtime54.jsx)(MenuButton, { tooltipLabel: "Insert horizontal line", IconComponent: HorizontalRule_default, disabled: !(editor === null || editor === void 0 ? void 0 : editor.isEditable) || !editor.can().setHorizontalRule(), onClick: () => editor === null || editor === void 0 ? void 0 : editor.chain().focus().setHorizontalRule().run(), ...props });
}
...
function MenuButtonRedo(props) {
  const editor = useRichTextEditorContext();
  return (0, import_jsx_runtime59.jsx)(MenuButton, { tooltipLabel: "Redo", tooltipShortcutKeys: ["mod", "Shift", "Z"], IconComponent: Redo_default, disabled: !(editor === null || editor === void 0 ? void 0 : editor.isEditable) || !editor.can().redo(), onClick: () => editor === null || editor === void 0 ? void 0 : editor.chain().focus().redo().run(), ...props });
}
...
function MenuButtonRemoveFormatting(props) {
  const editor = useRichTextEditorContext();
  return (0, import_jsx_runtime60.jsx)(MenuButton, { tooltipLabel: "Remove inline formatting", IconComponent: FormatClear_default, disabled: !(editor === null || editor === void 0 ? void 0 : editor.isEditable) || !editor.can().unsetAllMarks(), onClick: () => editor === null || editor === void 0 ? void 0 : editor.chain().focus().unsetAllMarks().run(), ...props });
}
...
function MenuButtonUndo(props) {
  const editor = useRichTextEditorContext();
  return (0, import_jsx_runtime67.jsx)(MenuButton, { tooltipLabel: "Undo", tooltipShortcutKeys: ["mod", "Z"], IconComponent: Undo_default, disabled: !(editor === null || editor === void 0 ? void 0 : editor.isEditable) || !editor.can().undo(), onClick: () => editor === null || editor === void 0 ? void 0 : editor.chain().focus().undo().run(), ...props });
}
  ...
  return (0, import_jsx_runtime71.jsxs)(MenuSelect, {
    ...
    renderValue: (value) => {
      if (!value || value === MULTIPLE_SIZES_SELECTED_VALUE) {
        return emptyLabel !== null && emptyLabel !== void 0 ? emptyLabel : (0, import_jsx_runtime71.jsx)(FormatSize_default, { className: classes.fontSizeIcon });
      }
