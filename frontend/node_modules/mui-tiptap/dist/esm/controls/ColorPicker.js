...
export function ColorPicker({ value, onChange, swatchColors, colorToHex = colorToHexDefault, disableAlpha = false, labels = {}, }) {
    ...
    return (_jsxs(_Fragment, { children: [disableAlpha ? (_jsx(HexColorPicker, { color: colorValueAsHex !== null && colorValueAsHex !== void 0 ? colorValueAsHex : "#000000", onChange: (color) => {
                    onChange(color, "gradient");
                }, className: classes.gradientPicker })) : (_jsx(HexAlphaColorPicker, { color: colorValueAsHex !== null && colorValueAsHex !== void 0 ? colorValueAsHex : "#000000", onChange: (color) => {
                    onChange(color, "gradient");
                ...
                }, fullWidth: true }), swatchColorObjects.length > 0 && (_jsx("div", { className: classes.swatchContainer, children: swatchColorObjects.map((swatchColor) => (_jsx(ColorSwatchButton, { value: swatchColor.value, label: swatchColor.label, onClick: () => {
                        var _a;
